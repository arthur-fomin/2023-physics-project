...
void ndDemoMesh::Render(ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
	if (m_isVisible)
	{
...
void ndDemoMesh::RenderGeometry(ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
	glUseProgram(m_shader);
...
void ndDemoMesh::RenderTransparency(ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
	if (m_isVisible)
	{
