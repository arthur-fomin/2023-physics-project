...
D_CLASS_REFLECTION_IMPLEMENT_LOADER(ndBaseEntityNotify)
D_CLASS_REFLECTION_IMPLEMENT_LOADER(ndBindingRagdollEntityNotify)

ndBaseEntityNotify::ndBaseEntityNotify(ndPhysicsViewer* const manager, ndBaseEntity* const entity, ndBodyKinematic* const parentBody, ndFloat32 gravity)
...
ndBaseEntityNotify::ndBaseEntityNotify(const ndLoadSaveBase::ndLoadDescriptor& desc)
...
ndBaseEntityNotify::~ndBaseEntityNotify()
{
...
void ndBaseEntityNotify::Save(const ndLoadSaveBase::ndSaveDescriptor& desc) const
{
...
void ndBaseEntityNotify::OnObjectPick() const
{
	ndTrace(("picked body id: %d\n", GetBody()->GetId()));
}

void ndBaseEntityNotify::OnApplyExternalForce(ndInt32, ndFloat32)
{
...
void ndBaseEntityNotify::OnTransform(ndInt32, const ndMatrix& matrix)
{
...
void ndBaseEntityNotify::RemoveBody()
{
	// check world bounds
...
ndBindingRagdollEntityNotify::ndBindingRagdollEntityNotify(ndPhysicsViewer* const manager, ndBaseEntity* const entity, ndBodyDynamic* const parentBody, ndFloat32 capSpeed)
	:ndBaseEntityNotify(manager, entity, parentBody)
	,m_bindMatrix(ndGetIdentityMatrix())
	,m_capSpeed(capSpeed)
{
	ndBaseEntity* const parentEntity = m_parentBody ? (ndBaseEntity*)(parentBody->GetNotifyCallback()->GetUserData()) : nullptr;
...
ndBindingRagdollEntityNotify::ndBindingRagdollEntityNotify(const ndLoadSaveBase::ndLoadDescriptor& desc)
	:ndBaseEntityNotify(ndLoadSaveBase::ndLoadDescriptor(desc))
...
{
	ndBaseEntityNotify::OnApplyExternalForce(thread, timestep);
