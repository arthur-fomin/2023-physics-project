...
ndBaseEntity* BuildVisualEntity(ndPhysicsViewer* const scene, ndInt32 grids, ndFloat32 gridSize, ndFloat32 perturbation)
{
...
ndBodyKinematic* BuildProceduralMap(ndPhysicsViewer* const scene, ndInt32 grids, ndFloat32 gridSize, ndFloat32 perturbation)
{
	...
	body->SetNotifyCallback(new ndBaseEntityNotify(scene, BuildVisualEntity(scene, grids, gridSize, perturbation)));
