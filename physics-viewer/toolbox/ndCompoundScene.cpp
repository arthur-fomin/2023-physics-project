...
static void AddBoxSubShape(ndPhysicsViewer* const scene, ndShapeInstance& sceneInstance, ndBaseEntity* const rootEntity, const ndMatrix& location)
{
...
static void AddSpeedBumpsSubShape(ndPhysicsViewer* const scene, ndShapeInstance& sceneInstance, ndBaseEntity* const rootEntity, const ndMatrix& location, ndInt32 count)
{
...
static void AddStaticMesh(ndPhysicsViewer* const scene, const char* const meshName, ndShapeInstance& sceneInstance, ndBaseEntity* const rootEntity, const ndMatrix& location)
{
	...
	ndBaseEntity* const visualEntity = new ndBaseEntity(scene, meshEffectNode);
...
ndBodyKinematic* BuildCompoundScene(ndPhysicsViewer* const scene, const ndMatrix& location)
{
	ndBaseEntity* const rootEntity = new ndBaseEntity(location, nullptr);
	...
	body->SetNotifyCallback(new ndBaseEntityNotify(scene, rootEntity));
...
#if 1
	// add the bridge
	ndBaseEntity* const pivot0 = rootEntity->Find("pivot1");
	ndBaseEntity* const pivot1 = rootEntity->Find("pivot0");
