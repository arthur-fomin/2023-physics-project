...
void ndDemoDebrisMesh::Render(ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
...
ndDemoDebrisEntity::ndDemoDebrisEntity(ndMeshEffect* const meshNode, ndArray<glDebrisPoint>& vertexArray, ndDemoDebrisRootEntity* const parent, const ndShaderCache& shaderCache)
	:ndBaseEntity(ndGetIdentityMatrix(), parent)
{
...
ndBaseEntity* ndDemoDebrisEntity::CreateClone() const
{
	return new ndDemoDebrisEntity(*this);
}

void ndDemoDebrisEntity::Render(ndFloat32, ndPhysicsViewer* const scene, const ndMatrix& matrix) const
{
...
void ndDemoDebrisRootEntity::Render(ndFloat32 timestep, ndPhysicsViewer* const scene, const ndMatrix& matrix) const
{
