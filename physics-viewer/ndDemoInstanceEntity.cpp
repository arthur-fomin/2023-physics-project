...
void ndDemoMeshIntance::RenderBatch(ndInt32 start, ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
	glBindBuffer(GL_ARRAY_BUFFER, m_matrixOffsetBuffer);
...
void ndDemoMeshIntance::Render(ndPhysicsViewer* const scene, const ndMatrix& modelMatrix)
{
...
void ndDemoInstanceEntity::Render(ndFloat32, ndPhysicsViewer* const scene, const ndMatrix& matrix) const
{
	D_TRACKTIME();
